...
const BlogSection = () => {
    ...
    return (
        ...
        <section className="wpo-blog-section section-padding" id='blog'>
            ...
            <BlogSingle open={open} blog={state.blog} onClose={handleClose} title={state.title} bImg={state.screens} create_at={state.create_at} author={state.author} comment={state.comment} />
        </section>
    );
}
